...
public class HoaDon_DAO {
	...
	private HoaDon buildHoaDonFromResultSet(ResultSet rs) throws SQLException {
		...
		Ban ban = ban_dao.timTheoMaBan(rs.getString("maBan"));
	...
	public boolean themHoaDon(HoaDon hd) {
		String sqlHD = "INSERT INTO HoaDon (maHoaDon, ngayTao, ghiChu, trangThaiThanhToan, maKhachHang, maNhanVien, maKM, maPTTT,maBan) VALUES (?, ?, ?, ?, ?, ?, ?, ?,?)";
